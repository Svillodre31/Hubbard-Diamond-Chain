...
namemaster = '/scratch/villodre/Hubbard_calculations/Codigos/codigos_calculos/Hubard_master_paral.py'
job_id = sys.argv[1]
recycle = False
U = 1000.0
t_max,t_min = 3.0,0.0
...
for i in range(len(t_max_r)):
    if recycle:
        models.append('{} {} {} {} {} {} {} {} {} {}'.format(namemaster,'R',U,t_max_r[i],t_steps,t_min_r[i],'P',points_account[i],job_id,date))
    else:
        models.append('{} {} {} {} {} {} {} {} {} {}'.format(namemaster,'NR',U,t_max_r[i],t_steps,t_min_r[i],'P',points_account[i],job_id,date))

if recycle:
    s(f'python {models[rank]} > /scratch/villodre/Hubbard_calculations/Outs/Outs_master_trozos/{job_id}_{date}/dmrgR_{job_id}_{rank}.out 2> /scratch/villodre/Hubbard_calculations/Error/Errores_master_trozos/{job_id}_{date}/Hubbarddmrg_paral_{job_id}_{rank}.err')
else :
    s(f'python {models[rank]} > /scratch/villodre/Hubbard_calculations/Outs/Outs_master_trozos/{job_id}_{date}/dmrgNR_{job_id}_{rank}.out 2> /scratch/villodre/Hubbard_calculations/Error/Errores_master_trozos/{job_id}_{date}/Hubbarddmrg_paral_{job_id}_{rank}.err')
